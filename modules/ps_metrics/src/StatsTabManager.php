...
class StatsTabManager
{
    ...
    {
        return $this->toggleLegacyStatsController(true) && $this->deleteMetricsController();
    }
    ...
    private function enableMetricsController()
    {
        ...
        $metricsTab = \Tab::getIdFromClassName($this->module->metricsStatsController);
        ...
        $tab->class_name = $this->module->metricsStatsController;
        $tab->active = true;
    ...
    {
        $metricsTab = new \Tab(\Tab::getIdFromClassName($this->module->metricsStatsController));
